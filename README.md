...
Runs the application in verbose mode for troubleshooting; it does not launch an interactive Python debugger.
...
| --- | --- | --- | --- |
| Linear path (2 drones)                     | maps/easy/01_linear_path.txt                | ≤6  | 4  |
| Simple fork (4 drones)                     | maps/easy/02_simple_fork.txt                | ≤8  | 4  |
| Basic capacity (4 drones)                  | maps/easy/03_basic_capacity.txt             | ≤6  | 4  |
| Dead end trap (5 drones)                   | maps/medium/01_dead_end_trap.txt            | ≤12 | 8  |
| Circular loop (6 drones)                   | maps/medium/02_circular_loop.txt            | ≤15 | 10 |
| Priority puzzle (5 drones)                 | maps/medium/03_priority_puzzle.txt          | ≤12 | 6  |
| Maze nightmare (8 drones)                  | maps/hard/01_maze_nightmare.txt             | ≤30 | 13 |
| Capacity hell (12 drones)                  | maps/hard/02_capacity_hell.txt              | ≤35 | 16 |
| Ultimate challenge (15 drones)             | maps/hard/03_ultimate_challenge.txt         | ≤45 | 26 |
| The Impossible Dream (25 drones, optional) | maps/challenger/01_the_impossible_dream.txt | ≤45 | 43 |
